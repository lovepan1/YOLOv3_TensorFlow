...
prune_model = BasePruning(args.prune_factor, nb_finetune_epochs=args.nb_finetune_epochs,
                          ...
                          checkpoint_dir='/home/pcl/tensorflow1.12/YOLOv3_TensorFlow/finetune_checkpoint/')
...
#################################### begining finetune ###########################################
    ...
    saver_to_restore_finetune.restore(sess, os.path.join('/home/pcl/tensorflow1.12/YOLOv3_TensorFlow/finetune_checkpoint/', 'kmeans_prune_restore_model_epoch_21_all.ckpt'))
    ...
    for epoch in range(prune_model._nb_finetune_epochs):
        ...
        if epoch % 3 ==0  and epoch > 0:
            saver_best_finetune.save(sess, os.path.join(args.prune_checkpoint_dir, ('kmeans_prune_restore_model_epoch_' + str(int(epoch)) + '_all.ckpt')))
